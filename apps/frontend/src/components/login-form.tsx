        ...
        <CardContent className="px-8 py-7">
          <form className="flex h-full flex-col" onSubmit={boardLogin}>
            <FieldGroup className="gap-5">
              ...
              <Field>
                <Button
                  className="h-10 w-full bg-indigo-500 text-white hover:bg-indigo-400"
                  type="submit"
                >
                  Sign in
                </Button>
                <Button
                  className="h-10 w-full border-white/15 bg-white/5 text-white hover:bg-white/10 hover:text-white"
                  variant="outline"
                  type="button"
                >
                  Login with Google
